...
This project implements a Docker container for [Firefox ESR](https://www.mozilla.org/en-CA/firefox/enterprise/).
...
`firefox-esr.domain.tld` to the container at `127.0.0.1:5800`.
...
`server.domain.tld/firefox-esr` to the container at `127.0.0.1:5800`.
